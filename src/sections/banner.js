          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              <Box sx={styles.banner.stars}>
                ...
                <FaStar />
                <FaStar />
                Reviewed by over 4,332 students
              </Box>
              <Heading as="h3">
                Improve grades <br />
                with Workflow
              ...
              <Text as="p">
                Be able to fully manage and control all aspects of your student life, <br />
                from your grades to your attendance using Workflow; <br />
                the best student management app on the web.
              </Text>
